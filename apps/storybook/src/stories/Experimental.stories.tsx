...
import { ITableProps, Table as TableComponent } from "@arkejs/table";
...
// arke-ui cli components

const Table = React.forwardRef<
  HTMLTableElement,
  React.HTMLAttributes<HTMLTableElement>
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto bg-red-500">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b transition-colors hover:bg-neutral/50 data-[state=selected]:bg-neutral",
      className
    )}
    {...props}
  />
